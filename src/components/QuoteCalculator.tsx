      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">        {/* Section Header */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7 bg-[#FAFAF9] border border-zinc-200/90 rounded-2xl p-6 sm:p-8 space-y-6">
            ...
            <div className="space-y-2">
              ...
              <select
                ...
                className="w-full bg-white border border-zinc-300 rounded-lg px-3.5 py-2.5 text-sm text-zinc-900 focus:outline-hidden focus:ring-2 focus:ring-[#0b5d6c] focus:border-transparent font-medium"
              >
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between text-xs">
                ...
                <span className="font-mono font-bold text-sm text-[#0b5d6c] bg-white px-2.5 py-0.5 rounded border border-zinc-200">
              ...
              <input
                ...
                className="w-full h-2 bg-zinc-200 rounded-lg appearance-none cursor-pointer accent-[#0b5d6c]"
              />
                  ...
                  <button
                    ...
                    className={`p-3 rounded-lg text-left transition-all cursor-pointer border ${
                      scriptComplexity === tier.id
                        ? 'border-[#0b5d6c] bg-[#0b5d6c] text-white shadow-2xs'
                        : 'border-zinc-200 bg-white text-zinc-700 hover:border-zinc-300'
                    }`}
                  >
                    <div className="text-xs font-bold">{tier.label}</div>
                    <div className={`text-[10px] mt-0.5 ${scriptComplexity === tier.id ? 'text-teal-100' : 'text-zinc-500'}`}>
                      {tier.desc}
                    </div>
                  </button>
                ))}
                  ...
                  <button
                    ...
                    className={`p-2.5 rounded-lg text-center text-xs font-semibold transition-all cursor-pointer border ${
                      turnaroundPriority === prio
                        ? 'border-[#0b5d6c] bg-[#e8f4f6] text-[#063740]'
                        : 'border-zinc-200 bg-white text-zinc-700 hover:border-zinc-300'
                    }`}
                  >
                    {prio}
          ...
          <div className="lg:col-span-5 space-y-4">
            <div className="bg-[#063740] border border-[#0b5d6c]/40 text-white rounded-2xl p-6 sm:p-7 shadow-lg space-y-6">
              
              <div className="flex items-center justify-between pb-4 border-b border-[#0b5d6c]/30">
                <div className="flex items-center space-x-2">
                  <Calculator className="w-5 h-5 text-[#09afa6]" />
                  <span className="font-bold text-sm tracking-tight">Scope Summary</span>
                </div>
                <span className="px-2 py-0.5 rounded bg-white/10 text-teal-200 font-mono text-[11px]">
              ...
              <div className="space-y-1 pt-3 border-t border-[#0b5d6c]/30">
                <div className="flex items-center space-x-2 text-teal-200 text-xs font-semibold uppercase tracking-wider">
                  <Users className="w-4 h-4 text-[#09afa6]" />
              ...
              {/* Package Inclusions */}
              <div className="space-y-2 pt-3 border-t border-[#0b5d6c]/30 text-xs text-zinc-300">
                <span className="font-semibold uppercase tracking-wider text-teal-200 block text-[11px]">
                  Included Deliverables:
                </span>
                <div className="space-y-1.5">
                  <div className="flex items-center space-x-2">
                    <FileCheck2 className="w-4 h-4 text-[#09afa6] shrink-0" />
              ...
              <div className="pt-2">
                <button
                  type="button"
                  onClick={handleApply}
                  className="w-full inline-flex items-center justify-center px-4 py-3 rounded-xl bg-[#09afa6] text-zinc-950 font-bold text-sm hover:bg-[#07968e] transition-colors shadow-sm cursor-pointer group"
                >
                  <Sparkles className="w-4 h-4 text-zinc-950 mr-2" />
